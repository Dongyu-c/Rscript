custom_data_prep = function(input_path, output_path) {
  ...
  # qpm_inp <- readRDS(file.path(input_path, "QPM_TGA_INP.rda"))
  ...
  setnames(rsnce, stringr::str_replace_all(toupper(names(rsnce)), "STD_", "sd."))
  ...
  qpm_rsnce_join <- left_join(rsnce, qpm_aggr, by='TGA_LOT_NUM', all.x = TRUE)
  qpm_rsnce_join <- as.data.table(qpm_rsnce_join)
  qpm_rsnce_join <- qpm_rsnce_join[!is.na(PRODUCT)]
  setnames(qpm_rsnce_join, 'ETL_LOAD_DATE.y', 'ETL_LOAD_DATE')
  qpm_rsnce_join[1:2]
  
  column_order <- c("TGA_LOT_NUM", "VENDOR", "CODENAME", "TESTER_TYPE", "FSA_LOT_NUM", "TEST_DATE", "ETL_LOAD_DATE.x", "RADIUS", "PARM_ID", "TAB", "TESTER_ID", "TEST_STATUS", "WORK_ORDER", 
				  "SPEC_VER", "RSNCE_STATUS", "RSNCE_ABOVE_12K", "CNT_HD", "RSNCE_YIELD", "PASS", "FRF_12KHZ_HIGAIN", "FRF_12KHZ_DIRECT", "FRF_16KHZ", "FRF_20KHZ", "FRF_36KHZ_ALIAS", "FRF_12KHZ_ALIAS", 
				  "VARITY_DEFECT", "GT1_FREQ", "GT1_GAIN", "GT2_FREQ", "GT2_GAIN", "BP_FREQ", "BP_GAIN", "SWAY_FREQ", "SWAY_GAIN", "GT4_FREQ", "GT4_GAIN", "YAW_FREQ", "YAW_GAIN", "GT1A_PHASE_FREQ", "GT1A_PHASE", 
				  "GT1B_PHASE_FREQ", "GT1B_PHASE", "GT1_FREQ_PHASE_NPEAK1", "GT1_PHASE_NPEAK1", "GT2_FREQ_PHASE_NPEAK1", "GT2_PHASE_NPEAK1", "BP_FREQ_PHASE_NPEAK1", "BP_PHASE_NPEAK1", "SWAY_FREQ_PHASE_NPEAK1", 
				  "SWAY_PHASE_NPEAK1", "GT4_FREQ_PHASE_NPEAK1", "GT4_PHASE_NPEAK1", "YAW_FREQ_PHASE_NPEAK1", "YAW_PHASE_NPEAK1", "UACT_STROKE", "PSA_IN", "PSA_OUT", "RSA_IN", "RSA_OUT", "sd.GT1_FREQ", "sd.GT1_GAIN", 
				  "sd.GT2_FREQ", "sd.GT2_GAIN", "sd.BP_FREQ", "sd.BP_GAIN", "sd.SWAY_FREQ", "sd.SWAY_GAIN", "sd.GT4_FREQ", "sd.GT4_GAIN", "sd.YAW_FREQ", "sd.YAW_GAIN", "sd.GT1A_PHASE_FREQ", "sd.GT1A_PHASE", 
				  "sd.GT1B_PHASE_FREQ", "sd.GT1B_PHASE", "sd.GT1_FREQ_PHASE_NPEAK1", "sd.GT1_PHASE_NPEAK1", "sd.GT2_FREQ_PHASE_NPEAK1", "sd.GT2_PHASE_NPEAK1", "sd.BP_FREQ_PHASE_NPEAK1", "sd.BP_PHASE_NPEAK1", 
				  "sd.SWAY_FREQ_PHASE_NPEAK1", "sd.SWAY_PHASE_NPEAK1", "sd.GT4_FREQ_PHASE_NPEAK1", "sd.GT4_PHASE_NPEAK1", "sd.YAW_FREQ_PHASE_NPEAK1", "sd.YAW_PHASE_NPEAK1", "sd.UACT_STROKE", "sd.PSA_IN", 
				  "sd.PSA_OUT", "sd.RSA_IN", "sd.RSA_OUT", "SUPPLIER_NAME", "SITE", "PRODUCT", "PRODUCT_PART_NUM", "COUNT",  
				  "RECORD_DATETIME", "ETL_LOAD_DATE", "LAT_LOT_NUM", "SBR_NUM", "SUB_LOT_NUM", "TGA_LOT_TYPE", "LINE_NUM", "DRAWING_NUM", "PART_REV", "DRAWING_REV", "BASEPLATE_LOT_NUM", "CA_LOT_NUM", 
				  "DAMPER_LOT_NUM", "DAMPER_REEL_NUM", "FLEXURE_LOT_NUM", "LOADBEAM_LOT_NUM", "NCA_LOT_NUM", "PZT_NEGATIVE_LOT_NUM", "PZT_NEGATIVE_WAFER_NUM", "PZT_POSITIVE_LOT_NUM", "PZT_POSITIVE_WAFER_NUM", 
				  "INP_BP_WASH", "INP_BP_SORTER", "INP_LB_WASH", "INP_LB_FORM", "INP_LASER_LAPPING", "INP_FLEX_SEPARATION", "INP_FLEX_PRE_SING", "INP_FLEX_PANEL_TRIM", "INP_FLEX_FINAL_SING", "INP_FLEX_SORTER", 
				  "INP_PZT_ATTACH", "INP_FLEX_FORM_SORT", "INP_LASER_WELD", "INP_TWO_IN_ONE_DETAB", "INP_WASHING1", "INP_PL_FORM_FINAL_DETAB", "INP_PL_FORM", "INP_ANNEALING", "INP_OVEN_CURE", "INP_FINAL_DETAB", 
				  "INP_WASHING2", "INP_DAMPER_ATTACH", "INP_GL_SA_ADJUST", "INP_CAPA_RESIST", "mean.GRAM_LOAD", "mean.PSA", "mean.RSA", "mean.ASSY_DIMPLE_POS_X", "mean.ASSY_DIMPLE_POS_Y", "mean.TAIL_ALIGN_X", 
				  "mean.TAIL_ALIGN_Y", "mean.ASSY_LIFT_TAB_OFFSET", "mean.STROKE", "mean.T1_NOTCH_LOC", "mean.LOAD_BEAM_TWIST", "mean.DCF", "mean.LEFT_PZT_CAPACITANCE", "mean.RIGHT_PZT_CAPACITANCE", 
				  "mean.LEFT_PZT_RESISTANCE", "mean.RIGHT_PZT_RESISTANCE", "mean.LEFT_PZT_CA_HEIGHT_BOTTOM", "mean.RIGHT_PZT_CA_HEIGHT_BOTTOM", "mean.LEFT_PZT_POSITION_X", "mean.RIGHT_PZT_POSITION_X", 
				  "mean.LEFT_PZT_POSITION_Y", "mean.RIGHT_PZT_POSITION_Y", "mean.COMP_PZT_LENGTH", "mean.COMP_PZT_WIDTH", "mean.COMP_PZT_THICKNESS", "mean.COMP_PZT_GAP3", "mean.COMP_PZT_GAP4", 
				  "mean.COMP_PZT_AU_THICKNESS", "mean.COMP_PZT_D31", "mean.COMP_LB_DIMPLE_POS_X", "mean.COMP_LB_DIMPLE_POS_Y", "mean.LB_1ST_TORSION_FREQ", "mean.LB_1ST_TORSION_GAIN", "mean.LB_1ST_SWAY_FREQ", 
				  "mean.LB_1ST_SWAY_GAIN", "mean.BOSS_ID", "mean.BOSS_OD", "mean.UPZT_LB1T_N_FREQ", "mean.UPZT_LB1T_N_GAIN", "mean.UPZT_LB1SWAY_N_FREQ", "mean.UPZT_LB1SWAY_N_GAIN", "mean.UPZT_G1T_N_FREQ", 
				  "mean.UPZT_G1T_N_GAIN", "mean.UPZT_G2T_N_FREQ", "mean.UPZT_G2T_N_GAIN", "mean.UPZT_GYAW_N_FREQ", "mean.UPZT_GYAW_N_GAIN", "mean.UPZT_BP1T_N_FREQ", "mean.UPZT_BP1T_N_GAIN", "mean.FID_HOLE_X1", 
				  "mean.FID_HOLE_X2", "mean.FID_HOLE_Y1", "mean.FID_HOLE_Y2", "mean.GIMBAL_1ST_FREQ", "mean.GIMBAL_1ST_GAIN", "mean.GIMBAL_ALIGN_X1", "mean.GIMBAL_ALIGN_X2", "mean.GIMBAL_ALIGN_X3", 
				  "mean.GIMBAL_ALIGN_X4", "mean.GIMBAL_ALIGN_X5", "mean.GIMBAL_ALIGN_X6", "mean.GIMBAL_ALIGN_X7", "mean.GIMBAL_ALIGN_X8", "mean.GIMBAL_ALIGN_X9", "mean.GIMBAL_ALIGN_X10", "mean.GIMBAL_ALIGN_X11", 
				  "mean.GIMBAL_ALIGN_Y1", "mean.GIMBAL_ALIGN_Y2", "mean.GIMBAL_ALIGN_Y3", "mean.GIMBAL_ALIGN_Y4", "mean.GIMBAL_ALIGN_Y5", "mean.GIMBAL_ALIGN_Y6", "mean.GIMBAL_ALIGN_Y7", "mean.GIMBAL_ALIGN_Y8", 
				  "mean.GIMBAL_ALIGN_Y9", "mean.GIMBAL_ALIGN_Y10", "mean.GIMBAL_ALIGN_Y11", "mean.GIMBAL_WIDTH_PAD1", "mean.GIMBAL_WIDTH_PAD2", "mean.GIMBAL_WIDTH_PAD3", "mean.GIMBAL_WIDTH_PAD4", 
				  "mean.GIMBAL_WIDTH_PAD5", "mean.GIMBAL_WIDTH_PAD6", "mean.GIMBAL_WIDTH_PAD7", "mean.GIMBAL_WIDTH_PAD8", "mean.GIMBAL_WIDTH_PAD9", "mean.GIMBAL_WIDTH_PAD10", "mean.GIMBAL_WIDTH_PAD11", 
				  'mean.LTEH_L1', 'mean.LTEH_R1', 'mean.LTEH_L2', 'mean.LTEH_R2', 'mean.LTEH_L3', 'mean.LTEH_R3', 
				  "sd.GRAM_LOAD", "sd.PSA", "sd.RSA", "sd.ASSY_DIMPLE_POS_X", "sd.ASSY_DIMPLE_POS_Y", "sd.TAIL_ALIGN_X", "sd.TAIL_ALIGN_Y", "sd.ASSY_LIFT_TAB_OFFSET", "sd.STROKE", "sd.T1_NOTCH_LOC", 
				  "sd.LOAD_BEAM_TWIST", "sd.DCF", "sd.LEFT_PZT_CAPACITANCE", "sd.RIGHT_PZT_CAPACITANCE", "sd.LEFT_PZT_RESISTANCE", "sd.RIGHT_PZT_RESISTANCE", "sd.LEFT_PZT_CA_HEIGHT_BOTTOM", 
				  "sd.RIGHT_PZT_CA_HEIGHT_BOTTOM", "sd.LEFT_PZT_POSITION_X", "sd.RIGHT_PZT_POSITION_X", "sd.LEFT_PZT_POSITION_Y", "sd.RIGHT_PZT_POSITION_Y", "sd.COMP_PZT_LENGTH", "sd.COMP_PZT_WIDTH", 
				  "sd.COMP_PZT_THICKNESS", "sd.COMP_PZT_GAP3", "sd.COMP_PZT_GAP4", "sd.COMP_PZT_AU_THICKNESS", "sd.COMP_PZT_D31", "sd.COMP_LB_DIMPLE_POS_X", "sd.COMP_LB_DIMPLE_POS_Y", "sd.LB_1ST_TORSION_FREQ", 
				  "sd.LB_1ST_TORSION_GAIN", "sd.LB_1ST_SWAY_FREQ", "sd.LB_1ST_SWAY_GAIN", "sd.BOSS_ID", "sd.BOSS_OD", "sd.UPZT_LB1T_N_FREQ", "sd.UPZT_LB1T_N_GAIN", "sd.UPZT_LB1SWAY_N_FREQ", "sd.UPZT_LB1SWAY_N_GAIN", 
				  "sd.UPZT_G1T_N_FREQ", "sd.UPZT_G1T_N_GAIN", "sd.UPZT_G2T_N_FREQ", "sd.UPZT_G2T_N_GAIN", "sd.UPZT_GYAW_N_FREQ", "sd.UPZT_GYAW_N_GAIN", "sd.UPZT_BP1T_N_FREQ", "sd.UPZT_BP1T_N_GAIN", "sd.FID_HOLE_X1", 
				  "sd.FID_HOLE_X2", "sd.FID_HOLE_Y1", "sd.FID_HOLE_Y2", "sd.GIMBAL_1ST_FREQ", "sd.GIMBAL_1ST_GAIN", "sd.GIMBAL_ALIGN_X1", "sd.GIMBAL_ALIGN_X2", "sd.GIMBAL_ALIGN_X3", "sd.GIMBAL_ALIGN_X4", 
				  "sd.GIMBAL_ALIGN_X5", "sd.GIMBAL_ALIGN_X6", "sd.GIMBAL_ALIGN_X7", "sd.GIMBAL_ALIGN_X8", "sd.GIMBAL_ALIGN_X9", "sd.GIMBAL_ALIGN_X10", "sd.GIMBAL_ALIGN_X11", "sd.GIMBAL_ALIGN_Y1", "sd.GIMBAL_ALIGN_Y2", 
				  "sd.GIMBAL_ALIGN_Y3", "sd.GIMBAL_ALIGN_Y4", "sd.GIMBAL_ALIGN_Y5", "sd.GIMBAL_ALIGN_Y6", "sd.GIMBAL_ALIGN_Y7", "sd.GIMBAL_ALIGN_Y8", "sd.GIMBAL_ALIGN_Y9", "sd.GIMBAL_ALIGN_Y10", "sd.GIMBAL_ALIGN_Y11", 
				  "sd.GIMBAL_WIDTH_PAD1", "sd.GIMBAL_WIDTH_PAD2", "sd.GIMBAL_WIDTH_PAD3", "sd.GIMBAL_WIDTH_PAD4", "sd.GIMBAL_WIDTH_PAD5", "sd.GIMBAL_WIDTH_PAD6", "sd.GIMBAL_WIDTH_PAD7", "sd.GIMBAL_WIDTH_PAD8", 
				  "sd.GIMBAL_WIDTH_PAD9", "sd.GIMBAL_WIDTH_PAD10", "sd.GIMBAL_WIDTH_PAD11", 'sd.LTEH_L1', 'sd.LTEH_R1', 'sd.LTEH_L2', 'sd.LTEH_R2', 'sd.LTEH_L3', 'sd.LTEH_R3', 
				  "n.GRAM_LOAD", "n.PSA", "n.RSA", "n.ASSY_DIMPLE_POS_X", "n.ASSY_DIMPLE_POS_Y", "n.TAIL_ALIGN_X", "n.TAIL_ALIGN_Y", 
				  "n.ASSY_LIFT_TAB_OFFSET", "n.STROKE", "n.T1_NOTCH_LOC", "n.LOAD_BEAM_TWIST", "n.DCF", "n.LEFT_PZT_CAPACITANCE", "n.RIGHT_PZT_CAPACITANCE", "n.LEFT_PZT_RESISTANCE", "n.RIGHT_PZT_RESISTANCE", 
				  "n.LEFT_PZT_CA_HEIGHT_BOTTOM", "n.RIGHT_PZT_CA_HEIGHT_BOTTOM", "n.LEFT_PZT_POSITION_X", "n.RIGHT_PZT_POSITION_X", "n.LEFT_PZT_POSITION_Y", "n.RIGHT_PZT_POSITION_Y", "n.COMP_PZT_LENGTH", 
				  "n.COMP_PZT_WIDTH", "n.COMP_PZT_THICKNESS", "n.COMP_PZT_GAP3", "n.COMP_PZT_GAP4", "n.COMP_PZT_AU_THICKNESS", "n.COMP_PZT_D31", "n.COMP_LB_DIMPLE_POS_X", "n.COMP_LB_DIMPLE_POS_Y", 
				  "n.LB_1ST_TORSION_FREQ", "n.LB_1ST_TORSION_GAIN", "n.LB_1ST_SWAY_FREQ", "n.LB_1ST_SWAY_GAIN", "n.BOSS_ID", "n.BOSS_OD", "n.UPZT_LB1T_N_FREQ", "n.UPZT_LB1T_N_GAIN", "n.UPZT_LB1SWAY_N_FREQ", 
				  "n.UPZT_LB1SWAY_N_GAIN", "n.UPZT_G1T_N_FREQ", "n.UPZT_G1T_N_GAIN", "n.UPZT_G2T_N_FREQ", "n.UPZT_G2T_N_GAIN", "n.UPZT_GYAW_N_FREQ", "n.UPZT_GYAW_N_GAIN", "n.UPZT_BP1T_N_FREQ", "n.UPZT_BP1T_N_GAIN", 
				  "n.FID_HOLE_X1", "n.FID_HOLE_X2", "n.FID_HOLE_Y1", "n.FID_HOLE_Y2", "n.GIMBAL_1ST_FREQ", "n.GIMBAL_1ST_GAIN", "n.GIMBAL_ALIGN_X1", "n.GIMBAL_ALIGN_X2", "n.GIMBAL_ALIGN_X3", "n.GIMBAL_ALIGN_X4", 
				  "n.GIMBAL_ALIGN_X5", "n.GIMBAL_ALIGN_X6", "n.GIMBAL_ALIGN_X7", "n.GIMBAL_ALIGN_X8", "n.GIMBAL_ALIGN_X9", "n.GIMBAL_ALIGN_X10", "n.GIMBAL_ALIGN_X11", "n.GIMBAL_ALIGN_Y1", "n.GIMBAL_ALIGN_Y2", 
				  "n.GIMBAL_ALIGN_Y3", "n.GIMBAL_ALIGN_Y4", "n.GIMBAL_ALIGN_Y5", "n.GIMBAL_ALIGN_Y6", "n.GIMBAL_ALIGN_Y7", "n.GIMBAL_ALIGN_Y8", "n.GIMBAL_ALIGN_Y9", "n.GIMBAL_ALIGN_Y10", "n.GIMBAL_ALIGN_Y11", 
				  "n.GIMBAL_WIDTH_PAD1", "n.GIMBAL_WIDTH_PAD2", "n.GIMBAL_WIDTH_PAD3", "n.GIMBAL_WIDTH_PAD4", "n.GIMBAL_WIDTH_PAD5", "n.GIMBAL_WIDTH_PAD6", "n.GIMBAL_WIDTH_PAD7", "n.GIMBAL_WIDTH_PAD8", 
				  "n.GIMBAL_WIDTH_PAD9", "n.GIMBAL_WIDTH_PAD10", "n.GIMBAL_WIDTH_PAD11", 'n.LTEH_L1', 'n.LTEH_R1', 'n.LTEH_L2', 'n.LTEH_R2', 'n.LTEH_L3', 'n.LTEH_R3')

  qpm_rsnce_join  <- qpm_rsnce_join[, column_order, with = FALSE]
  ...
  qpm_inp <- qpm_inp %>% 
  filter_at(vars(names(qpm_inp)[-1:-2]), any_vars(!is.na(.)))
  ...
  # qpm_inp <- qpm_inp[,colSums(is.na(qpm_inp))<nrow(qpm_inp)]

  num_vars <- names(qpm_inp)[!names(qpm_inp) %in% c("GROUP_NUM", "RECORD_SEQ")]
  grp_cols <- c("GROUP_NUM")

  qpm_inp <- as.data.table(qpm_inp)

  inp_qpm_mean <- qpm_inp[, lapply(.SD, mean, na.rm = TRUE), .SDcols = num_vars, grp_cols]
  inp_qpm_sd <- qpm_inp[, lapply(.SD, sd, na.rm = TRUE), .SDcols = num_vars, grp_cols]
  inp_qpm_n <- qpm_inp[, lapply(.SD, FUN = function(x) sum(complete.cases(x))), .SDcols = num_vars, grp_cols]

  inp_qpm_mean[is.NaN(inp_qpm_mean)] <- NA # found many, need handle
  inp_qpm_sd[is.NaN(inp_qpm_sd)] <- NA # found none, but to be sured
  inp_qpm_n[is.NaN(inp_qpm_n)] <- NA # found none, but to be sured

  setnames(inp_qpm_mean, num_vars, paste0('mean.', num_vars))
  setnames(inp_qpm_sd, num_vars, paste0('sd.', num_vars))
  setnames(inp_qpm_n, num_vars, paste0('n.', num_vars))

  inp_qpm_aggr <- data.table(GROUP_NUM = unique(qpm_inp$GROUP_NUM), stringsAsFactors = F)

  inp_qpm_aggr <- left_join(inp_qpm_aggr, inp_qpm_mean)
  inp_qpm_aggr <- left_join(inp_qpm_aggr, inp_qpm_sd)
  inp_qpm_aggr <- left_join(inp_qpm_aggr, inp_qpm_n)

  rm(inp_qpm_mean)
  rm(inp_qpm_sd)
  rm(inp_qpm_n)
  
  names(inp_qpm_aggr)[1] <- "TGA_LOT_NUM"
  
  qpm_rsnce_join <- left_join(qpm_rsnce_join, inp_qpm_aggr)
  
  fwrite(qpm_rsnce_join, file = file.path(output_path, 'TGADashboardAnalysis@qpm_rsnce_join.csv'), quote = TRUE) # quote = TRUE required for tableau comma separated value within same attr_column

  rm(inp_qpm_aggr)
  # rm(qpm_rsnce_join_inp)

  ##### Supplier Data #####
 
  null_list <- c('RADIUS','PARM_ID','WORK_ORDER','SPEC_VER','TESTER_ID')
  # supplier_set <- qpm_rsnce_join
  ...
  fwrite(qpm_rsnce_join, file = file.path(output_path, 'TGADashboardAnalysis@qpm_rsnce_join_supplier.csv'), quote = TRUE) # quote = TRUE required for tableau comma separated value within same attr_column
  
  qpm_rsnce_join <- qpm_rsnce_join[qpm_rsnce_join$SUPPLIER_NAME %in% 'NHK',]
  
  fwrite(qpm_rsnce_join, file = file.path(output_path, 'TGADashboardAnalysis@qpm_rsnce_join_supplier(NHK).csv'), quote = TRUE)
  ...
  # key_col <- c('TGA_LOT_NUM','VENDOR','CODENAME','TESTER_TYPE','FSA_LOT_NUM','TEST_DATE','ETL_LOAD_DATE.x','RADIUS','PARM_ID','TAB',
               ...
               # 'INP_OVEN_CURE','INP_FINAL_DETAB','INP_WASHING2','INP_DAMPER_ATTACH','INP_GL_SA_ADJUST','INP_CAPA_RESIST','CNT_HD')
  ...
  # var_col <- c('GT1_FREQ','GT1_GAIN','GT2_FREQ','GT2_GAIN','BP_FREQ','BP_GAIN','SWAY_FREQ','SWAY_GAIN','GT4_FREQ','GT4_GAIN','YAW_FREQ','YAW_GAIN','UACT_STROKE','PSA_IN','PSA_OUT','RSA_IN','RSA_OUT',
               ...
               # 'mean.GIMBAL_WIDTH_PAD9','mean.GIMBAL_WIDTH_PAD10','mean.GIMBAL_WIDTH_PAD11','FRF_12KHZ_HIGAIN','FRF_12KHZ_DIRECT','FRF_16KHZ','FRF_20KHZ','FRF_36KHZ_ALIAS','FRF_12KHZ_ALIAS','VARITY_DEFECT')
  ...
  # naming_case = rlang::exprs(
    # .$variable %in% c('GT1_FREQ','GT1_GAIN','GT2_FREQ','GT2_GAIN','BP_FREQ','BP_GAIN','SWAY_FREQ','SWAY_GAIN','GT4_FREQ','GT4_GAIN','YAW_FREQ','YAW_GAIN','UACT_STROKE','PSA_IN','PSA_OUT','RSA_IN','RSA_OUT') ~ 'CTQ_VAR',
    # grepl('mean.',.$variable) ~ 'CTQ_VAR',
    # .$variable %in% c('FRF_12KHZ_HIGAIN','FRF_12KHZ_DIRECT','FRF_16KHZ','FRF_20KHZ','FRF_36KHZ_ALIAS','FRF_12KHZ_ALIAS','VARITY_DEFECT') ~ 'CTQ_VAR'
  # )
  
  # ctq_naming_case = rlang::exprs(
    # .$variable %in% c('GT1_FREQ','GT1_GAIN','GT2_FREQ','GT2_GAIN','BP_FREQ','BP_GAIN','SWAY_FREQ','SWAY_GAIN','GT4_FREQ','GT4_GAIN','YAW_FREQ','YAW_GAIN','UACT_STROKE','PSA_IN','PSA_OUT','RSA_IN','RSA_OUT') ~ paste0('HGA.', .$variable),
